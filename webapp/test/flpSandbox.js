		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "oDataPeople",
									"targetURL": "#Peopleodatapeople-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Peopleodatapeople-display": {
								"semanticObject": "Peopleodatapeople",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=People.odatapeople",
									"url": sap.ui.require.toUrl("People/odatapeople")
								}
							}
						}
					}
